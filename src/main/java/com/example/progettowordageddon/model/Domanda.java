...
/// @class Domanda
/// @brief Rappresenta una domanda a scelta multipla con quattro
/// risposte e una risposta corretta.
/// @ingroup model
///
/// La classe permette di gestire domande per quiz, memorizzare
/// la risposta selezionata e verificare se la risposta data è
/// corretta.
public class Domanda implements Serializable {
    ...
    /// @brief Indice (`0-3`) della risposta selezionata,
    /// o `null` se non ancora risposta.
